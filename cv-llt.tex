...
\myname{Vo}{Minh\bibnamedelima Thanh}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Minh Thanh Vo }
  
  \makefield{\faMapMarker}{Gunja-dong, Gwangjin-gu , Seoul, Republic of Korea}
  
  \makefield{\faBirthdayCake}{May 27th, 1994}
  
  \makefield{\faPhone}{(+82)10-5391-0533}
  
  \makefield{\faEnvelopeO}{\texttt{vmthanhit@gmail.com}}
  
  \makefield{\faSkype}{\texttt{luckyluck379}}
  
  \makefield{\faGit}{\url{https://github.com/vmthanh}}
  
  \makefield{\faLinkedinSquare}
  {\url{https://www.linkedin.com/in/minh-thanh-vo-a4997ba2/}}
...
\makerubric{skills}
\makerubric{research_experiences}
